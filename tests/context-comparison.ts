 ...
 *   WITHOUT context-mode-opencode: raw file content (every byte enters context)
 *   WITH context-mode-opencode: only the printed summary enters context
 *
...
async function main() {
  ...
  for (const scenario of scenarios) {
    ...
    console.log(`\u2502`);
    console.log(
      `\u2502 WITHOUT context-mode-opencode (raw Read/cat):`,
    );
    console.log(
    ...
    console.log(`\u2502`);
    console.log(
      `\u2502 WITH context-mode-opencode (execute_file):`,
    );
    console.log(
  ...
  console.log(
    `  WITHOUT context-mode-opencode: ${(debugRaw / 1024).toFixed(1)}KB → ${Math.ceil(debugRaw / 4).toLocaleString()} tokens (${((debugRaw / 4 / 200_000) * 100).toFixed(1)}% of context GONE)`,
  );
  console.log(
    `  WITH context-mode-opencode:    ${(debugCtx / 1024).toFixed(1)}KB → ${Math.ceil(debugCtx / 4).toLocaleString()} tokens (${((debugCtx / 4 / 200_000) * 100).toFixed(2)}% of context)`,
  );
  console.log(
